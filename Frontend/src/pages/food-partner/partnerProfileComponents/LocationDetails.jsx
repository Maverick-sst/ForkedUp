...
const LocationDetails = ({
  ...
  return (
    ...
    >
      ...
      <input
        type="text"
        name="location.address.block"
        placeholder="Block / Sector"
        value={locationData.address.block}
        onChange={onInputChange}
        className="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring-brand-orange"
      />
      <input
        type="text"
        name="location.address.building"
        placeholder="Building Name"
        value={locationData.address.building}
        onChange={onInputChange}
        className="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring-brand-orange"
      />
      <input
        type="text"
        name="location.address.floor"
        placeholder="Floor / Apartment"
        value={locationData.address.floor}
        onChange={onInputChange}
        className="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring-brand-orange"
      />
      <input
        ...
        value={locationData.address.landmark}
        onChange={onInputChange}
        className="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring-brand-orange"
      />
    </AccordionSection>

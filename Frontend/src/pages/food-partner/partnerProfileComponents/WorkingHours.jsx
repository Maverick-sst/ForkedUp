  ...
  return (
    <div className="py-3 border-b border-brand-gray-light last:border-b-0">
      <div className="flex items-center justify-between">
        <label className="font-semibold text-brand-gray">
          {daysOfWeek[dayIndex]}
        </label>
        ...
        <div className="pl-4 mt-2 space-y-2 animate-fade-in">
          {day.periods.map((period, periodIndex) => (
            <div key={periodIndex} className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => onRemovePeriod(dayIndex, periodIndex)}
          ...
          <button
            type="button"
            onClick={() => onAddPeriod(dayIndex)}
            className="flex items-center text-sm text-brand-orange hover:underline"
          >
...
const WorkingHours = ({
  ...
  return (
    <AccordionSection
      ...
      onClick={onToggle}
    >
      {Array.isArray(workingHoursData) &&

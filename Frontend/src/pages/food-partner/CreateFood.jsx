          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex justify-center text-sm text-gray-600">
                    <label
                      htmlFor="file-upload"
                      className="relative cursor-pointer bg-white rounded-md font-medium text-brand-orange hover:text-brand-peach"
                    >
                      <span>
                        {previewUrl ? "Change video" : "Upload a video"}
                      </span>
                      <input
                        id="file-upload"
                        name="file-upload"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <select
                ...
                value={textData.dietaryPreference}
                onChange={handleChange}
                className="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring-brand-orange"
              >
                <option>Veg</option>
